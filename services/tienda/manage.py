...
from project.api.models import Tienda  # <-- nuevo
...
def seed_db():
    """Seeds the database."""
    db.session.add(Tienda(nombre='TiendaB', sucursal="LaEra",direccion="Alameda",telefono="123465",encargado="Juan"))
    db.session.commit()
